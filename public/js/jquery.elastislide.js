...
$(document).ready(function(){
	$('.tab002').click(function(){
		$('.event-video-wrap').css({'opacity':'1','visibility':'visible','z-index':'10'});
		$('.event-gallery-wrap').css({'opacity':'0','visibility':'hidden','z-index':'0'});
	});
	$('.tab001').click(function(){
		$('.event-gallery-wrap').css({'opacity':'1','visibility':'visible','z-index':'10'});
		$('.event-video-wrap').css({'opacity':'0','visibility':'hidden','z-index':'0'});
	});
});
